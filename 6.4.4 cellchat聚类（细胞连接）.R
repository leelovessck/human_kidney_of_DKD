...
netAnalysis_river(con.chat,
                  pattern = "outgoing")
  ##得到1.4 control的outgoing模式冲击图-模式（细胞连接）
...
netAnalysis_river(con.chat,
                  pattern = "incoming")
  ##得到2.4 control的incoming模式冲击图-模式（细胞连接）
...
netAnalysis_river(dkd.chat,
                  pattern = "outgoing")
  ##得到4.4 DKD的outgoing模式冲击图-模式（细胞连接）
...
netAnalysis_river(dkd.chat,
                  pattern = "incoming")
  ##得到5.4 DKD的incoming模式冲击图-模式（细胞连接）
