...
gg2 <- rankNet(cellchat,
               ...
               targets.use = "EC-GC")
gg1 + gg2
  ##得到2-1.EC-GC的细胞外基质的比较柱状图-数量（详细通路）
...
gg2 <- rankNet(cellchat,
               ...
               targets.use = "EC-AEA")
gg1 + gg2
  ##得到2-2.EC-AEA的细胞外基质的比较柱状图-数量（详细通路）
...
gg2 <- rankNet(cellchat,
               ...
               targets.use = "EC-GC")
gg1 + gg2
  ##得到3-1.EC-GC的细胞外基质的比较柱状图-强度（详细通路）
...
gg2 <- rankNet(cellchat,
               ...
               targets.use = "EC-AEA")
gg1 + gg2
  ##得到3-2.EC-AEA的细胞外基质的比较柱状图-强度（详细通路）
...
patchwork::wrap_plots(plots = list(gg1, gg2, gg3),
                      ncol = 3)
  ##得到7.1 细胞外基质的in out散点图(按细胞类型)
patchwork::wrap_plots(plots = list(gg4, gg5, gg6),
                      ncol = 3)
  ##得到7.2 细胞外基质的in out散点图(按细胞类型)
patchwork::wrap_plots(plots = list(gg7, gg8, gg9),
                      ncol = 3)
  ##得到7.3 细胞外基质的in out散点图(按细胞类型)
patchwork::wrap_plots(plots = list(gg10, gg11, gg12),
                      ncol = 3)
  ##得到7.4 细胞外基质的in out散点图(按细胞类型)
patchwork::wrap_plots(plots = list(gg13, gg14, gg15),
                      ncol = 3)
  ##得到7.5 细胞外基质的in out散点图(按细胞类型)
...
ht1 = netAnalysis_signalingRole_heatmap(con.chat, 
                                        pattern = "outgoing", 
                                        signaling = con.chat@netP$pathways, 
                                        title = "CON", 
                                        width = 5, 
                                        height = 5, 
                                        color.heatmap = "GnBu")
