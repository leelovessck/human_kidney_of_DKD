...
con.chat <- identifyCommunicationPatterns(con.chat, 
                                          ...
                                          width = 5,
                                          height = 5)
  ##得到1.2 control的outgoing模式热图-模式（细胞外基质）
...
con.chat <- identifyCommunicationPatterns(con.chat, 
                                          ...
                                          width = 5,
                                          height = 5)
  ##得到1.3 control的outgoing模式热图-细胞（细胞外基质）

netAnalysis_river(con.chat,
                  pattern = "outgoing")
  ##得到1.4 control的outgoing模式冲击图-模式（细胞外基质）

netAnalysis_dot(con.chat,
                pattern = "outgoing")
  ##得到1.5 control的outgoing模式气泡图（细胞外基质）
...
con.chat <- identifyCommunicationPatterns(con.chat, 
                                          ...
                                          width = 5,
                                          height = 5)
  ##得到2.3 control的incoming模式热图-细胞（细胞外基质）

netAnalysis_river(con.chat,
                  pattern = "incoming")
  ##得到2.4 control的incoming模式冲击图-模式（细胞外基质）

netAnalysis_dot(con.chat,
                pattern = "incoming")
  ##得到2.5 control的incoming模式气泡图（细胞外基质）
...
dkd.chat <- identifyCommunicationPatterns(dkd.chat, 
                                          ...
                                          width = 5,
                                          height = 5)
  ##得到5.3 DKD的incoming模式热图-细胞（细胞外基质）

netAnalysis_river(dkd.chat,
                  pattern = "incoming")
  ##得到5.4 DKD的incoming模式冲击图-模式（细胞外基质）

netAnalysis_dot(dkd.chat,
                pattern = "incoming")
  ##得到5.5 DKD的incoming模式气泡图（细胞外基质）
