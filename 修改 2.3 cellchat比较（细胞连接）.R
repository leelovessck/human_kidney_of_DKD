...
####数据准备############################
#数据准备
con.chat <- readRDS("./cellchat的rds/control（细胞连接）.rds")
dkd.chat <- readRDS("./cellchat的rds/DKD（细胞连接）.rds")
...
gg2 <- rankNet(cellchat,
               ...
               targets.use = "EC-GC")
gg1 + gg2
  ##得到2-1.EC-GC的细胞连接的比较柱状图-数量（详细通路）
...
gg2 <- rankNet(cellchat,
               ...
               targets.use = "EC-AEA")
gg1 + gg2
  ##得到2-2.EC-AEA的细胞连接的比较柱状图-数量（详细通路）
...
gg2 <- rankNet(cellchat,
               ...
               targets.use = "EC-GC")
gg1 + gg2
  ##得到3-1.EC-GC的细胞连接的比较柱状图-强度（详细通路）
...
gg2 <- rankNet(cellchat,
               ...
               targets.use = "EC-AEA")
gg1 + gg2
  ##得到3-2.EC-AEA的细胞连接的比较柱状图-强度（详细通路）
