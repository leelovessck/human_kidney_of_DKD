...
gg2 <- rankNet(cellchat,
               ...
               targets.use = "EC-GC")
gg1 + gg2
##得到2-1.EC-GC的旁、自分泌的比较柱状图-数量（详细通路）
...
gg2 <- rankNet(cellchat,
               ...
               targets.use = "EC-AEA")
gg1 + gg2
  ##得到2-2.EC-AEA的旁、自分泌的比较柱状图-数量（详细通路）
...
gg2 <- rankNet(cellchat,
               ...
               targets.use = "EC-GC")
gg1 + gg2
  ##得到3-1.EC-GC的旁、自分泌的比较柱状图-强度（详细通路）
...
gg2 <- rankNet(cellchat,
               ...
               targets.use = "EC-AEA")
gg1 + gg2
  ##得到3-2.EC-AEA的旁、自分泌的比较柱状图-强度（详细通路）
